...
public class QrLoginService {
    ...
    public void approve(QrApproveRequest request) {
        ...
        redisTemplate.opsForValue().set(QR_KEY_PREFIX + request.tokenHash() + ":access",  accessToken,  QR_JWT_TTL);
        redisTemplate.opsForValue().set(QR_KEY_PREFIX + request.tokenHash() + ":refresh", refreshToken, QR_JWT_TTL);
