...
import { validateCorporateJoin } from '@/lib/validation'
...
export default function CorporateJoinPage() {
  ...
  function handleStep1() {
    const err = validateCorporateJoin({
      corpName, corpEnglishName, corpRegNo, bizRegNo, tradeName,
      openingDate, ntsIndustryCode, ksicCode, bizItemCode,
    })
